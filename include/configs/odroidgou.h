...
#define CONFIG_CMD_USB				1
	...
	/* USB Host Hub Reset */
	#define CONFIG_USB_HUB_RST_N		GPIOEE(GPIOZ_0)
	#define CONFIG_USB_HUB_RST_N_NAME	"GPIOZ_0"
	/* USB Host Hub Enable */
	#define CONFIG_USB_HUB_CHIP_EN		GPIOEE(GPIOZ_1)
	#define CONFIG_USB_HUB_CHIP_EN_NAME	"GPIOZ_1"
	/* USB OTG Power Enable */
	#define CONFIG_USB_GPIO_PWR		GPIOEE(GPIOZ_2)
	#define CONFIG_USB_GPIO_PWR_NAME	"GPIOZ_2"
...
#define CONFIG_SYSTEM_ON_VOL_THRESD		3480
#define CONFIG_SCREEN_ON_VOL_THRESD		3600
